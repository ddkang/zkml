...
mod tests {
  ...
  use crate::commitments::{
    poseidon::{p128pow5t3::P128Pow5T3, test_vectors},
    primitives::{permute, ConstantLength, Spec},
  };

  use P128Pow5T3 as OrchardNullifier;
  ...
  fn poseidon_hash() {
    ...
    let output =
      crate::commitments::primitives::Hash::<_, OrchardNullifier, ConstantLength<2>, 3, 2>::init()
        .hash(message);
  ...
  fn poseidon_hash_longer_input() {
    ...
    let output =
      crate::commitments::primitives::Hash::<_, OrchardNullifier, ConstantLength<3>, 3, 2>::init()
        .hash(message);
